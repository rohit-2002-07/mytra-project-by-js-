...
bagItemsObjects.forEach(bagItem=>{
  ...
  let finlePayment =totalMrp-totaleDiscount+CUNVINIUNCE_FEE;
  ...
  bagsummaryElement.innerHTML=`<div class="bag-details-container">
            ...
            <div class="price-item">
              ...
              <span class="price-item-value priceDetail-base-discount">-Rs${totaleDiscount}</span>
            </div>
            <div class="price-item">
            ...
            <div class="price-footer">
              ...
              <span class="price-item-value">Rs ${finlePayment}</span>
            </div>
          </div>
